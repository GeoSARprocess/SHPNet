...
class GeometricTnf(object):
    ...
    """
    def __init__(self, geometric_model='affine', tps_grid_size=3, tps_reg_factor=0, out_h=240, out_w=240, offset_factor=None, device='cpu'):
        self.out_h = out_h
        self.out_w = out_w
        ...
        if geometric_model=='affine' and offset_factor is None:
            ...
            self.gridGen = AffineGridGenV2(out_h=out_h, out_w=out_w, device=device)
    ...
    def __call__(self, image_batch, theta_batch=None, out_h=None, out_w=None, return_warped_image=True, return_sampling_grid=False, padding_factor=1.0, crop_factor=1.0):
        ...
        # sample transformed image
        # warped_image_batch = F.grid_sample(image_batch,  sampling_grid) #ori
        warped_image_batch = F.grid_sample(image_batch,  sampling_grid.float())  #luoru
...
class AffineGridGenV2(Module):
    def __init__(self, out_h=240, out_w=240, device='cpu'):
