...
import numpy as np
from model.geotnf.grid_gen import TpsGridGen
from model.geotnf.transformation import homography_mat_from_4_pts
...
class PointTnf(object):
    ...
    """
    def __init__(self, device, tps_grid_size=3, tps_reg_factor=0):
